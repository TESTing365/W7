...
$w7_system_menu['account_manage'] = array(
	...
	'dimension' => 2,
	'url' => url('account/manage/display'),
	'section' => array(
	...
	'section' => array(
		'platform' => array(
			...
			'menu' => array(
				...
				'platform_draft' => array(
					'title' => '草稿箱',
					'url' => url('platform/draft/display'),
					'icon' => 'wi wi-article',
					'permission_name' => 'platform_draft',
					'is_display' => array(
						ACCOUNT_TYPE_OFFCIAL_NORMAL,
						ACCOUNT_TYPE_OFFCIAL_AUTH,
					),
					'sub_permission' => array(
						'platform_draft_material' => array(
							'title' => '创作',
							'url' => url('platform/draft/display', array('type' => 'draft')),
							'permission_name' => 'platform_draft_material',
							'active' => 'draft',
						),
						'platform_draft_news' => array(
							'title' => '历史图文素材',
							'url' => url('platform/draft/display', array('type' => 'news', 'server' => 'perm')),
							'permission_name' => 'platform_draft_news',
							'active' => 'news',
						)
					)
				),
				'platform_publish' => array(
					'title' => '发表记录',
					'url' => url('platform/draft/publish_list'),
					'icon' => 'wi wi-send',
					'permission_name' => 'platform_publish',
					'is_display' => array(
						ACCOUNT_TYPE_OFFCIAL_NORMAL,
						ACCOUNT_TYPE_OFFCIAL_AUTH,
					)
		...
		'profile' => array(
			...
			'menu' => array(
				...
				'profile_app_module_link' => array(
					...
					'permission_name' => 'profile_app_module_link',
					'is_display' => array(
						ACCOUNT_TYPE_OFFCIAL_NORMAL,
						ACCOUNT_TYPE_OFFCIAL_AUTH,
					),
		...
		'publish' => array(
			...
			'menu' => array(
				'publish_front_download' => array(
					'title' => '发布设置',
					'url' => !empty($_W['account']['type_sign']) && $_W['account']['type_sign'] == 'phoneapp' ? url('phoneapp/front-download') : url('wxapp/front-download'),
					'is_display' => array(
						ACCOUNT_TYPE_APP_NORMAL,
						ACCOUNT_TYPE_APP_AUTH,
						ACCOUNT_TYPE_WXAPP_WORK,
